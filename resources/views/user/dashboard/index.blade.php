            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  ">
                                <li class="me-4">
                                    <h6 class="text-info">
                                        <i class="mdi mdi-checkbox-blank-circle font-10 me-2"></i>Mobile
                                    </h6>
                                </li>
                                <li class="me-4">
                                    <h6 class="text-primary">
                                        <i class="mdi mdi-checkbox-blank-circle font-10 me-2"></i>Desktop
                                    </h6>
                                </li>
                                <li class="me-4">
                                    <h6 class="text-success">
                                        <i class="mdi mdi-checkbox-blank-circle font-10 me-2"></i>Tablet
                                    </h6>
                                </li>
                            </ul>
                        </div>
                  ...
                  ">Follow</a>
                            <div class="row text-center mt-3">
                                <div class="col-lg-4 col-md-4 mt-3">
                                    <h3 class="mb-0 font-light">1099</h3>
                                    <small>Articles</small>
                                </div>
                                <div class="col-lg-4 col-md-4 mt-3">
                                    <h3 class="mb-0 font-light">23,469</h3>
                                    <small>Followers</small>
                                </div>
                                <div class="col-lg-4 col-md-4 mt-3">
                                    <h3 class="mb-0 font-light">6035</h3>
                                        ...
                                        <div class="sl-item">
                                            ...
                                            <div class="sl-right">
                                                <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 mb-3">
                                                            <img src="../assets/images/big/img1.jpg" alt="user"
                                                                class="img-responsive radius w-100" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-6 mb-3">
                                                    ...
                                                    <div class="like-comm">
                                                        <a href="javascript:void(0)" class="link me-2">2
                                                            comment</a>
                                                        <a href="javascript:void(0)" class="link me-2"><i
                                                                class="mdi mdi-heart fs-4 text-danger"></i>
                                                            5 Love</a>
                                                    </div>
                                                </div>
                                            </div>
