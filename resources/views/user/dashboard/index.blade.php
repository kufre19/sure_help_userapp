...
<html dir="ltr" lang="en">
  <head>
    ...
    <!-- chartist CSS -->
    <link
      href="{{asset('custom/userdashboard/assets/plugins/chartist-js/dist/chartist.min.css')}}"
      rel="stylesheet"
    />
    <link
      href="{{asset('custom/userdashboard/assets/plugins/chartist-js/dist/chartist-init.css')}}"
      rel="stylesheet"
    />
    <link
